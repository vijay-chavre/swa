...
export default class Youtube extends Component {
  render() {
    return (
      <svg style={this.props.style} viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet" focusable="false"><g viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet" >
          <g>
