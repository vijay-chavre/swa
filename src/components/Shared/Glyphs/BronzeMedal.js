...
export default class BronzeMedal extends Component {
  render() {
    return (
      <svg className="a-glyph" width="128" height="176" viewBox="0 0 128 176" xmlns="http://www.w3.org/2000/svg">
        <g transform="translate(-1008.000000, -376.000000) translate(1008.000000, 376.000000)" fill="none">
          ...
          <path d="M61.92 84.294c.393-.792 1.2-1.294 2.083-1.294.883 0 1.692.502 2.083 1.294l7.47 15.14c.338.683.993 1.16 1.75 1.27l16.706 2.426c.876.126 1.6.74 1.874 1.58.273.84.046 1.764-.587 2.38l-12.09 11.785c-.55.533-.8 1.302-.67 2.055l2.85 16.64c.15.873-.208 1.753-.926 2.273-.716.518-1.663.587-2.447.178l-14.943-7.852c-.675-.355-1.485-.355-2.16 0l-14.944 7.856c-.78.41-1.73.343-2.446-.176-.717-.52-1.074-1.4-.925-2.273l2.852-16.64c.13-.752-.122-1.52-.67-2.054L34.7 107.09c-.63-.617-.86-1.54-.585-2.38.273-.84 1-1.454 1.875-1.58l16.71-2.427c.757-.11 1.41-.586 1.75-1.272l7.474-15.13z" fill="#ED843C"/>
        </g>
      </svg>
    );
  }
