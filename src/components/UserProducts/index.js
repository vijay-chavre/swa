    ...
    return (
      <div>
        <section className="b-section">
            ...
            <div className={`o-subscription o-subscription--product(${  this.getProductStyle(product)  })`}>
              ...
              <div className="o-subscription__planInfo">
                <p className="o-subscription__student a-p(16)">
                  {`${Localization.localizedStringForKey('Grade')} ${product.product_grade}`}
                </p>
          ...
          )) : <p className="a-p(14)">Did you know Thinkster has workbooks for PARCC, SBAC, Aptitude Tests and more for purchase? This add-on is available with your Thinkster subscription for a special price. Click Buy Workbooks to learn more.</p>
          }
        </section>
